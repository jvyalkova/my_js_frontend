...
export function todoAdd(_id, name, description, genre){
	return { type: TODO_ADD, _id, name, description, genre }
}
...
export function todoFullUpdate(_id){
	return { type: TODO_FULL_UPDATE, _id }
}
